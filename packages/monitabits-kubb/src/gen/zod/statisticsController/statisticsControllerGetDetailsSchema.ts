 ...
 */
export const statisticsControllerGetDetails200Schema = z.lazy(() => statisticsDetailsResponseDtoSchema)
...
export const statisticsControllerGetDetailsQueryResponseSchema = z.lazy(() => statisticsControllerGetDetails200Schema)